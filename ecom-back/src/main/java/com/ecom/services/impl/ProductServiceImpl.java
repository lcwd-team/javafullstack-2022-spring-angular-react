...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse getAllProducts(int pageNumber, int pageSize, String sortBy, String sortDir) {
        ...
        List<Product> allLive = all.stream().filter(p -> p.isLive()).collect(Collectors.toList());
        List<ProductDto> dtos = allLive.stream().map(product -> this.mapper.map(product, ProductDto.class))
